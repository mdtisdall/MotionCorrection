#ifndef MovingWeightedMovingMResidualGradientAndHessian_h
#define MovingWeightedMovingMResidualGradientAndHessian_h
...
class MovingWeightedMovingMResidualGradientAndHessian :
